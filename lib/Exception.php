...
/**
 * The main OPT exception class. An addition is the possibility
 * of adding some extra data to the exception that could be used
 * by the exception processor.
 *
 * @package Exceptions
 */
...
{
	/**
	 * The optional extra exception data.
	 * @internal
	 * @var mixed
	 */
	private $_data;
	...
	/**
	 * Sets the exception extra data. Implements fluent interface.
	...
	/**
	 * Returns the extra data associated with the exception.
	 * @return mixed
	 */
...
class Opt_InvalidOptionValue_Exception extends Opt_Exception
{
	protected $_message = 'Invalid value for option %s: %s';
} // end Opt_InvalidOptionValue_Exception;
...
} // end Opt_EngineNotExists_Exception;
